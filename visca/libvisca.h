...
VISCA_API uint32_t VISCA_get_info(VISCAInterface_t *iface, VISCACamera_t *camera);
...
VISCA_API uint32_t VISCA_set_pantilt_limit_upright(VISCAInterface_t *iface, VISCACamera_t *camera, int pan_limit,
						   int tilt_limit);

VISCA_API uint32_t VISCA_set_pantilt_limit_downleft(VISCAInterface_t *iface, VISCACamera_t *camera, int pan_limit,
						    int tilt_limit);
